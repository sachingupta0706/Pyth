      ...
      <div className={classes.bannerContainer}>
        ...
        <div className={classes.content}>
          ...
          <div className={classes.mainTitle}>
            Get <span className={classes.highlight}>10%-Off</span> Your </div><div className={classes.tx2}>
            First Visit</div>
          ...
          <Link href="#">BOOK NOW</Link></div> 
          <div className={classes.btniconn}><MdArrowForwardIos /></div>
